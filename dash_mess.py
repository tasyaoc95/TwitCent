...
app_colors = {
    'background': '#FFF',
    'text':'#000000',
    'sentiment-plot':'#99bbff',
    'volume-bar':'#99FF99',
    'someothercolor':'#99bbff',
}
...
app.layout = html.Div(
      [  html.Div(className='container-fluid', style={'width':'100%','max-width':50000, 'background-color':'#99bbff', 'height': 50}, children=[
                                                        html.I(id='dove', className='fas fa-dove', style={'color':'#FFF', 'text-align': 'left', 'font-size' : 20, 'margin-top' : 15, 'margin-left' : 15}),
                                                        html.H5('TwitCent', style={'color':'#FFF', 'text-align': 'left','font-family': 'arial', 'font-size' : 18,'margin-top': -22, 'margin-left' : 45})
                                                        ]),

                                                 html.Div(className='container-fluid',children=[
                                                  html.I(id='search', className='fas fa-search',style={'color':'#99bbff', 'font-size' : 33, 'margin-left':'18%', 'margin-top': 40, 'margin-bottom' : 40}),
                                                  dcc.Input(id='sentiment_term', value='twitter', type='text', style={'margin-left': 15,'margin-top': 30, 'width': '50%', 'background-color':'#f2f2f2', 'box-shadow': '#888888', 'box-shadow' : 5,'box-shadow' : 10, 'border-radius' : 5})

                                                  ],
                 style={'width':'100%'}),

        html.Div(className='row', children=[html.Div(id='related-sentiment', children=html.Button('Loading related terms...', id='related_term_button'), className='col s12 m6 l6', style={"word-wrap":"break-word",'font-weight': 'bold'}),
                                            html.Div(id='recent-trending', className='col s12 m6 l6', style={"word-wrap":"break-word",'font-weight': 'bold'})]),

        dcc.Tabs(id="tabs", children=[
        dcc.Tab(label='Live Sentiment', children=[
            html.Div(className='row', style={'margin-left':'15%','width' :'130%','height':'130%'},children=[
        ...
        dcc.Tab(label='Historical Sentiment', children=[
             html.Div(className='row', children=[
               html.Div(className='row', style={'margin-left':'15%','width' :'130%','height':'130%'},children=[
        ...
        dcc.Tab(label='Recent Tweets', children=[
            html.Div(className='row', children=[
